                ...
                <div class="card-body">
                    <form action="{{ route('salary-payments.store-generated') }}" method="POST" id="generateForm">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="bonus_amount">Bonus Amount (NPR)</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="deductions">Deductions (NPR)</label>
                        ...
                        <div class="alert alert-info">
                            ...
                            <strong>Note:</strong> The salary will be automatically calculated based on the employee's salary type and the selected payment period. Tax will be calculated automatically based on employee's marital status (Nepal tax rules).
