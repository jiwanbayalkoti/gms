{{-- Member Form Partial - Used in Modal --}}
@csrf
...
<div class="form-group">
    ...
    @if(isset($member))
        ...
        @if($photoUrl)
            <div class="mb-2">
                <img src="{{ $photoUrl }}" alt="{{ $member->name }}" class="img-thumbnail" width="100" id="current-photo" style="object-fit: cover;" onerror="this.style.display='none';">
            </div>
        @endif
    @endif
...
<div class="form-group">
    <div class="form-check">
        <input class="form-check-input" type="checkbox" id="active" name="active" value="1" {{ old('active', isset($member) ? $member->active : true) ? 'checked' : '' }}>
...
<div class="form-group mb-0">
    <div class="d-flex justify-content-end">
        ...
        <button type="submit" class="btn btn-primary">
            <i class="fas fa-save"></i> {{ isset($member) ? 'Update' : 'Create' }} Member
        </button>
    </div>
</div>
