...
<div class="card mb-3">
    ...
    <div class="card-body">
        <div class="form-group">
            ...
            <textarea class="form-control @error('breakfast') is-invalid @enderror" id="breakfast" name="breakfast" rows="2" placeholder="e.g., Oatmeal with fruits, 2 eggs">{{ old('breakfast', $plan->breakfast ?? '') }}</textarea>
            @error('breakfast')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control @error('lunch') is-invalid @enderror" id="lunch" name="lunch" rows="2" placeholder="e.g., Grilled chicken with vegetables">{{ old('lunch', $plan->lunch ?? '') }}</textarea>
            @error('lunch')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control @error('dinner') is-invalid @enderror" id="dinner" name="dinner" rows="2" placeholder="e.g., Salmon with quinoa and salad">{{ old('dinner', $plan->dinner ?? '') }}</textarea>
            @error('dinner')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="form-group mb-0">
            ...
            <textarea class="form-control @error('snacks') is-invalid @enderror" id="snacks" name="snacks" rows="2" placeholder="e.g., Protein shake, nuts, fruits">{{ old('snacks', $plan->snacks ?? '') }}</textarea>
            @error('snacks')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
...
<div class="form-group">
    ...
    <textarea class="form-control @error('notes') is-invalid @enderror" id="notes" name="notes" rows="3" placeholder="Additional notes or instructions">{{ old('notes', $plan->notes ?? '') }}</textarea>
    @error('notes')
        <div class="invalid-feedback">{{ $message }}</div>
    @enderror
</div>
